...
```
yay -S hyprland-nvidia-git xdg-user-dirs xdg-desktop-portal-hyprland-git polkit-kde-agent qt6-wayland dunst waybar-hyprland hyprpaper-git slurp wofi weston nemo dkms
```
...
```
yay -S armcord-bin duplicity tmux neovim-nightly-bin github-cli google-chrome zsh layan-gtk-theme-git kora-icon-theme lsplug grim grimblast-git wl-clipboard obs-studio v4l2loopback-dkms rmtrash
```   
